...
if FLAGS.model_type == 'bprmf':
    data_generator = BPRMF_loader(FLAGS=FLAGS, path=FLAGS.data_path + FLAGS.dataset_name)
    batch_test_flag = False

elif FLAGS.model_type == 'cke':
    data_generator = CKE_loader(FLAGS=FLAGS, path=FLAGS.data_path + FLAGS.dataset_name)
    batch_test_flag = False

elif FLAGS.model_type in ['cfkg']:
    data_generator = CFKG_loader(FLAGS=FLAGS, path=FLAGS.data_path + FLAGS.dataset_name)
    batch_test_flag = True

elif FLAGS.model_type in ['fm','nfm']:
    data_generator = NFM_loader(FLAGS=FLAGS, path=FLAGS.data_path + FLAGS.dataset_name)
    batch_test_flag = True

elif FLAGS.model_type in ['kgat']:

    data_generator = KGAT_loader(FLAGS=FLAGS, path=FLAGS.data_path + FLAGS.dataset_name)
